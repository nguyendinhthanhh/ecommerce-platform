...
const MyOrdersPage = () => {
  ...
  const handleConfirmReceived = async (orderId) => {
    if (
      !window.confirm(
        "Bạn có chắc chắn muốn xác nhận rằng bạn đã nhận được đơn hàng này không?",
      )
    ) {
      return;
    }
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl p-12 text-center shadow-sm border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">
              Bắt đầu mua sắm để thấy đơn hàng của bạn ở đây
            </p>
            <Link
              to="/"
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-bold border flex items-center gap-1 ${getStatusColor(order.status)}`}
                        >
                          <span className="material-symbols-outlined text-sm">
                            {getStatusIcon(order.status)}
                          </span>
                          {getStatusLabel(order.status)} {/* <--- Đổi ở đây */}
                        </span>
                      </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-bold border flex items-center gap-1 ${getStatusColor(selectedOrder.status)}`}
                  >
                    <span className="material-symbols-outlined text-sm">
                      ...
                      const getColors = () => {
                        ...
                        const colors = {
                          ...
                          green: {
                            bg: "bg-green-600",
                            text: "text-white",
                            ring: "ring-4 ring-green-50",
                          },
                          rose: {
                            bg: "bg-rose-600",
                            text: "text-white",
                            ring: "ring-4 ring-rose-50",
                          },
                        };
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 pt-1.5">
                            <p
                              className={`text-sm font-bold ${isCurrent ? "text-gray-900" : "text-gray-500"}`}
                            >
                              {event.title}
                            </p>
                  ...
                  <table className="w-full">
                    ...
                    <tfoot className="bg-gray-50 border-t border-gray-200">
                      <tr>
                        <td
                          colSpan="2"
                          className="px-4 py-2 pt-4 text-right font-medium text-gray-600"
                        >
                          Subtotal:
                        </td>
                        <td className="px-4 py-2 pt-4 text-right font-medium text-gray-900">
                      ...
                      <tr>
                        <td
                          colSpan="2"
                          className="px-4 py-2 pb-4 text-right font-medium text-gray-600"
                        >
                          Tax (10%):
                        </td>
                        <td className="px-4 py-2 pb-4 text-right font-medium text-gray-900">
                      ...
                      <tr className="border-t border-gray-200 bg-white">
                        <td
                          colSpan="2"
                          className="px-4 py-4 text-right font-bold text-gray-900 text-lg"
                        >
                          Total:
                        </td>
                        <td className="px-4 py-4 text-right font-black text-blue-600 text-xl">
