          ...
          <div className="flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[#0f0d1b] dark:text-gray-200 text-sm font-semibold">
                  Email Address
                </label>
              ...
              <div className="flex items-center gap-2 px-1">
                ...
                />
                <label
                  className="text-[#524c9a] dark:text-gray-400 text-sm"
                  htmlFor="remember"
                >
                  Keep me signed in
                </label>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white dark:bg-background-dark px-2 text-[#524c9a] dark:text-gray-400">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 h-12 border border-[#d1cfe7] dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <img
                  alt="Google logo"
                  className="size-4"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDVD9F1EhNe_xHFWSuqq0EWhp6guU2HZr0ZDvxlYLugRswQl4Ts3jbzKnCVWzeV981g10T4WMcV33KhfNxDWH_WPgSP2UFJKSCcGWBD6Jf3NSDLuGTYMRRbl0rtEW7ZQt1EcykcZnHF2M7ZG7k6LODKKaXLYj4yh2H8IISg9kidjo23ETxdXb9JwzECYPU-Em52DQlVZ6kT437KyFpsXKnkybx-XV-X7-5EYouunoV7F26UnL3L1TI7WLHnruQM9iuXd2N6_gmkd2I"
                />
                <span className="text-sm font-semibold text-[#0f0d1b] dark:text-white">
                  Google
                </span>
              </button>
              <button className="flex items-center justify-center gap-2 h-12 border border-[#d1cfe7] dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                <span className="material-symbols-outlined text-[#1877F2] text-[20px]">
                  social_leaderboard
                </span>
                <span className="text-sm font-semibold text-[#0f0d1b] dark:text-white">
                  Facebook
