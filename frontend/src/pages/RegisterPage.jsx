      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white dark:bg-background-dark">
        <div className="w-full max-w-[480px] flex flex-col">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h2 className="text-[#0f0d1b] dark:text-white text-3xl font-bold leading-tight tracking-[-0.015em] mb-2">Create Account</h2>
              <p className="text-[#524c9a] dark:text-gray-400 text-base font-normal">Join us for a personalized AI shopping experience</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#0f0d1b] dark:text-gray-200 text-xs font-bold uppercase tracking-wider">Full Name</label>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#0f0d1b] dark:text-gray-200 text-xs font-bold uppercase tracking-wider">Email Address</label>
                <div className="flex w-full items-stretch rounded-xl border border-[#d1cfe7] dark:border-gray-700 bg-[#f8f8fc] dark:bg-gray-800 focus-within:border-primary transition-all">
                  <div className="text-[#524c9a] dark:text-gray-400 flex items-center justify-center pl-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#0f0d1b] dark:text-gray-200 text-xs font-bold uppercase tracking-wider">Password</label>
                <div className="flex w-full items-stretch rounded-xl border border-[#d1cfe7] dark:border-gray-700 bg-[#f8f8fc] dark:bg-gray-800 focus-within:border-primary transition-all">
                  <div className="text-[#524c9a] dark:text-gray-400 flex items-center justify-center pl-4">
                  ...
                  {[1, 2, 3, 4].map((level) => (
                    <div 
                      ...
                      className={`h-1 flex-1 rounded-full ${
                        level <= passwordStrength ? 'bg-primary' : 'bg-primary/20'
                      }`}
                    ></div>
                  ))}
                  {formData.password && (
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[#0f0d1b] dark:text-gray-200 text-xs font-bold uppercase tracking-wider">Confirm Password</label>
                <div className="flex w-full items-stretch rounded-xl border border-[#d1cfe7] dark:border-gray-700 bg-[#f8f8fc] dark:bg-gray-800 focus-within:border-primary transition-all">
                  <div className="text-[#524c9a] dark:text-gray-400 flex items-center justify-center pl-4">
              ...
              <div className="flex items-start gap-2 px-1 mt-2">
                <input 
                  ...
                  type="checkbox"
                />
                <label className="text-[#524c9a] dark:text-gray-400 text-xs leading-relaxed" htmlFor="terms">
                  I agree to the <a className="text-primary font-bold" href="#">Terms &amp; Conditions</a> and understand how my data is processed.
                </label>
              </div>
