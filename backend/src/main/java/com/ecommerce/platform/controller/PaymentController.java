...
public class PaymentController {
    ...
    public ResponseEntity<?> createPaymentUrl(@RequestParam String orderCode, @RequestParam String method) {
        try {
    ...
    public ResponseEntity<?> momoCallback(@RequestParam Map<String, String> allParams) {
        ...
        boolean success = paymentService.processCallback(txnRef, resultCode);
