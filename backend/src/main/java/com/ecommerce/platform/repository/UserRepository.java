...
public interface UserRepository extends JpaRepository<User, Long>, JpaSpecificationExecutor<User> {
        ...
        List<User> findUsersWithRole(@Param("roleName") String roleName, @Param("status") User.UserStatus status);
        ...
        @Query("SELECT u FROM User u JOIN u.roles r WHERE r.name = :roleName AND u.status <> :status")
        Page<User> findUsersWithRole(@Param("roleName") String roleName, @Param("status") User.UserStatus status,
                        Pageable pageable);
        ...
        long countUsersWithRole(@Param("roleName") String roleName, @Param("status") User.UserStatus status);
        ...
        int bulkUpdateStatus(@Param("ids") List<Long> ids, @Param("status") User.UserStatus status,
